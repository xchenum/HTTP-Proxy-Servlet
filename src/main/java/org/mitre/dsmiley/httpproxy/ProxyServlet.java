...
public class ProxyServlet extends HttpServlet {
  ...
  /* INIT PARAMETER NAME CONSTANTS */
    ...
    /**
     * A boolean parameter name to enable link rewrite
     */
  ...
  /* MISC */
    ...
    protected void copyResponseEntity(
        ...
        copyResponseEntity(proxyResponse, servletResponse, null);
    }
    ...
    protected String rewriteUrl(
        ...
        String tUrlString = getTargetUri(servletRequest);
        try {
            URL tUrl = new URL(getTargetUri(servletRequest));

            if (url.startsWith("/")) {
                if (url.startsWith(tUrl.getPath())) {
                    // if returned /ui/stage and targetUri is /ui
                    // we need to rewrite to .../stage
